# Form implementation generated from reading ui file '/Volumes/KINGSTON/Dev/python/python.my-manager.v3/ui/dialog_re_product.ui'
#
...
"border-radius: 4px;")
        ...
        self.transaction_container_w = QtWidgets.QGroupBox(parent=Dialog_REProduct)
        ...
        self.gridLayout.addWidget(self.status_combobox, 0, 2, 1, 1)
...
"}")
        ...
        Dialog_REProduct.setTabOrder(self.pid_input, self.status_combobox)
        Dialog_REProduct.setTabOrder(self.status_combobox, self.categories_combobox)
    ...
    def retranslateUi(self, Dialog_REProduct):
        ...
        self.status_combobox.setItemText(0, _translate("Dialog_REProduct", "Trạng thái"))
        ...
        self.description_label.setText(_translate("Dialog_REProduct", "Mô tả thêm"))
        self.legal_s_combobox.setItemText(0, _translate("Dialog_REProduct", "Pháp lý"))
