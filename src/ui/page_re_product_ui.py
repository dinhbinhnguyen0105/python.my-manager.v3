# Form implementation generated from reading ui file '/Volumes/KINGSTON/Dev/python/python.my-manager.v2/ui/page_re_product.ui'
#
...
class Ui_PageREProduct(object):
    ...
    def retranslateUi(self, PageREProduct):
        ...
        self.options_label.setText(_translate("PageREProduct", "Loại hình kinh doanh"))
        self.options_combobox.setItemText(0, _translate("PageREProduct", "Tất cả"))
        ...
        self.action_settings_btn.setText(_translate("PageREProduct", "Settings"))
