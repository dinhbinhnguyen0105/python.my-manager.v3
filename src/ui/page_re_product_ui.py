...
class Ui_PageREProduct(object):
    def setupUi(self, PageREProduct):
        PageREProduct.setObjectName("PageREProduct")
        PageREProduct.resize(1200, 600)
        font = QtGui.QFont()
        font.setFamily("Courier New")
        PageREProduct.setFont(font)
        PageREProduct.setStyleSheet(
            "#REProduct{\n"
        ...
        self.horizontalLayout_6 = QtWidgets.QHBoxLayout(PageREProduct)
        self.horizontalLayout_6.setContentsMargins(8, 8, 8, 8)
        self.horizontalLayout_6.setSpacing(0)
        self.horizontalLayout_6.setObjectName("horizontalLayout_6")
        self.horizontalLayout_5 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_5.setObjectName("horizontalLayout_5")
        self.contents_container_w = QtWidgets.QWidget(parent=PageREProduct)
        ...
        self.line = QtWidgets.QFrame(parent=PageREProduct)
        self.line.setStyleSheet("margin:0;")
        self.line.setFrameShape(QtWidgets.QFrame.Shape.VLine)
        self.line.setFrameShadow(QtWidgets.QFrame.Shadow.Sunken)
        self.line.setObjectName("line")
        self.horizontalLayout_5.addWidget(self.line)
        self.details_container_w = QtWidgets.QWidget(parent=PageREProduct)
        ...
        self.retranslateUi(PageREProduct)
        QtCore.QMetaObject.connectSlotsByName(PageREProduct)

    def retranslateUi(self, PageREProduct):
        _translate = QtCore.QCoreApplication.translate
        PageREProduct.setWindowTitle(_translate("PageREProduct", "Form"))
        self.function_label.setText(_translate("PageREProduct", "Công năng"))
        self.wards_label.setText(_translate("PageREProduct", "Phường"))
        self.wards_combobox.setItemText(0, _translate("PageREProduct", "Tất cả"))
        self.transaction_label.setText(
            _translate("PageREProduct", "Loại hình kinh doanh")
        )
        self.transaction_combobox.setItemText(0, _translate("PageREProduct", "Tất cả"))
        self.categories_label.setText(
            _translate("PageREProduct", "Danh mục bất động sản")
        )
        self.categories_combobox.setItemText(0, _translate("PageREProduct", "Tất cả"))
        self.building_line_s_label.setText(_translate("PageREProduct", "Lộ giới"))
        self.building_line_s_combobox.setItemText(
            0, _translate("PageREProduct", "Tất cả")
        )
        self.furniture_s_lable.setText(_translate("PageREProduct", "Nội thất"))
        self.furniture_s_combobox.setItemText(0, _translate("PageREProduct", "Tất cả"))
        self.legal_s_label.setText(_translate("PageREProduct", "Pháp lý"))
        self.legal_s_combobox.setItemText(0, _translate("PageREProduct", "Tất cả"))
        self.pid_label.setText(_translate("PageREProduct", "PID"))
        self.street_label.setText(_translate("PageREProduct", "Tên đường"))
        self.area_label.setText(_translate("PageREProduct", "Diện tích"))
        ...
        self.action_templates_btn.setText(_translate("PageREProduct", "Templates"))
        self.action_default_btn.setText(_translate("PageREProduct", "Default"))
        self.action_random_btn.setText(_translate("PageREProduct", "Random"))
