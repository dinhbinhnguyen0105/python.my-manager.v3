...
class Ui_Dialog_REProduct(object):
    def setupUi(self, Dialog_REProduct):
        ...
        self.availability_combobox = QtWidgets.QComboBox(parent=self.basic_container_w)
        self.availability_combobox.setObjectName("availability_combobox")
        self.availability_combobox.addItem("")
        self.gridLayout.addWidget(self.availability_combobox, 0, 2, 1, 1)
